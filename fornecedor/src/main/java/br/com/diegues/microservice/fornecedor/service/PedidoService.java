...
import br.com.diegues.microservice.fornecedor.dto.ItemDoPedidoDTO;
import br.com.diegues.microservice.fornecedor.model.Pedido;
import br.com.diegues.microservice.fornecedor.model.PedidoItem;
import br.com.diegues.microservice.fornecedor.model.Produto;
import br.com.diegues.microservice.fornecedor.repository.PedidoRepository;
    ...
    private List<PedidoItem> toPedidoItem(List<ItemDoPedidoDTO> itens) {
        ...
        List<PedidoItem> pedidoItens = itens
                ...
                .map(item -> {
                    ...
                    pedidoItem.setQuantidade(item.getQuantity());
                    return pedidoItem;
                })
                .collect(Collectors.toList());
        return pedidoItens;
